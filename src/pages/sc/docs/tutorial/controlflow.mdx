...
But f you write these two expressions in the same rule, Lexurgy will run them _simultaneously_. Later expressions don't see the effects of earlier expressions:
